...
class MessagesRVAdapter(private val context: Context,private val messages:ArrayList<Message>) :RecyclerView.Adapter<MessagesRVAdapter.MyViewHolder>() {
...
//        checking if it's a different day so as to show the date
